...
public class World {
     ...
     * Values must be bijection with the countries-set.
     */
    private final HashMap<String, Country> countriesByCode = new HashMap<>();
    /**
     * Existing countries by short name.
     * Values must be bijection with the countries-set.
     */
    ...
    /**
     * Create a World containing an immutable set of countries, where every country has a unique short name and
     * ISO 3166-1 Alpha-2 country-code.
     *
     * @param countries The list of every country this world contains
     * @throws DuplicateIdentifierException If two countries have the same countryCode or short name
     */
