...
package globingular.ui {
    ...
    class AppController [[java:globingular.ui.AppController]] {
        ...
        -{static}ObservableList<Country> createSortedVisitedCountriesList(CountryCollector countryCollector)
        -{static}ObservableList<Visit> createObservableVisitsToCountryList(CountryCollector targetCountryCollector, Country filterCountry)
...
This diagram shows how classes within UI connects to the classes from `globingular.persistence` and `globingular.core`. 
